    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h1 class="mb-3 fw-bold text-white">Pelayanan Pascarehabilitasi</h1>
                <p class="text-white-50 mb-4">Informasi mengenai layanan lanjutan setelah menjalani rehabilitasi.</p>
                <form action="{{ route('artikel.pelayanan') }}" method="GET" class="d-flex justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                <div class="card shadow-sm border-0 w-100 h-100 transition-hover">
                    ...
                    <div class="card-body pt-3 d-flex flex-column">
                        <div class="mb-2"><span class="badge bg-success bg-opacity-10 text-success rounded-pill px-3">Pelayanan</span></div>
