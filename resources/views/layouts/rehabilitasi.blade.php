    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h1 class="mb-3 fw-bold text-white">Rehabilitasi & Pemulihan</h1>
                <p class="text-white-50 mb-4">Informasi lengkap mengenai proses rehabilitasi dan pemulihan bagi korban penyalahgunaan narkoba.</p>
                <form action="{{ route('artikel.rehabilitasi') }}" method="GET" class="d-flex justify-content-center">
                    <div class="input-group" style="max-width: 500px;">
                        <input type="text" name="search" class="form-control" placeholder="Cari artikel rehabilitasi..." value="{{ request('search') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                <div class="card shadow-sm border-0 w-100 h-100 transition-hover">
                    ...
                    <div class="card-body pt-3 d-flex flex-column">
                        <div class="mb-2"><span class="badge bg-info bg-opacity-10 text-info rounded-pill px-3">Rehabilitasi</span></div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-auto border-top pt-3">
                            ...
                            <small class="text-info fw-bold">Baca <i class="fas fa-arrow-right ms-1"></i></small>
                        </div>
                    </div>
                </div>
            </div>
