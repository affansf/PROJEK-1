    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h1 class="mb-3 fw-bold text-white">Peredaran Gelap</h1>
                <p class="text-white-50 mb-4">Informasi dan berita terkait modus serta kasus peredaran gelap narkoba.</p>
                <form action="{{ route('artikel.peredaran') }}" method="GET" class="d-flex justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                <div class="card shadow-sm border-0 w-100 h-100 transition-hover">
                    ...
                    <div class="card-body pt-3 d-flex flex-column">
                        <div class="mb-2"><span class="badge bg-dark bg-opacity-10 text-dark rounded-pill px-3">Peredaran Gelap</span></div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-auto border-top pt-3">
                            ...
                            <small class="text-dark fw-bold">Baca <i class="fas fa-arrow-right ms-1"></i></small>
                        </div>
                    </div>
                </div>
            </div>
