    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h1 class="mb-3 fw-bold text-white">Penegakan Hukum Narkotika</h1>
                <p class="text-white-50 mb-4">Berita dan artikel terkini mengenai aspek hukum dan penegakan kasus narkotika.</p>
                <form action="{{ route('artikel.hukum') }}" method="GET" class="d-flex justify-content-center">
                    <div class="input-group" style="max-width: 500px;">
                        <input type="text" name="search" class="form-control" placeholder="Cari berita hukum..." value="{{ request('search') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                <div class="card shadow-sm border-0 w-100 h-100 transition-hover">
                    ...
                    <div class="card-body pt-3 d-flex flex-column">
                        <div class="mb-2"><span class="badge bg-danger bg-opacity-10 text-danger rounded-pill px-3">Hukum</span></div>
